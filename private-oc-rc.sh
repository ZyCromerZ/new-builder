...
################################################################################################ Avalon
    ...
    folder="all"
    FolderUpload="X01BD/KERNELS/Tercydux-oc/Release-Candidate/"
    ...
    build "QStormbreaker60Hz" "" "-1001301538740"
    build "QStormbreaker65Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker66Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker67Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker68Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker69Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker71Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "QStormbreaker72Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    ...
    build "PStormbreaker60Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker65Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker66Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker67Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker68Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker69Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker71Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
    build "PStormbreaker72Hz" "" "-1001301538740" 1>/dev/null 2>/dev/null && echo "build done . . ."
